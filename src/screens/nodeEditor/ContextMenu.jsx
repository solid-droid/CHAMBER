        ...
        <Show when={type() == 0}>
          ...
          <div class="column">
            ...
            <div class="section" style="margin-top:10px;">Simulator</div>
              ...
              <div class="item" onClick={(e) => props.newNode(e , 'Sphere3D')}>Sphere</div>
          ...
          <div class="column">
            <div class="section">Signals</div>
              ...
              <div class="item" onClick={(e) => props.newNode(e , 'Blueprint')}>Blueprint</div>
            <div class="section" style="margin-top:10px;">Logic</div>
              ...
              <div class="item" onClick={(e) => props.newNode(e , 'Javascript')}>Script</div>
          </div>
          </div>
        </Show>
        <Show when={type() == 1}>
